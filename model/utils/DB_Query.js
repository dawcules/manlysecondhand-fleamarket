...
const selectProductInfo = (data,callback) => {
    ...
    connection.query(
        'SELECT * FROM Product WHERE pType = ?, pBrand = ?, pCondition BETWEEN ? AND 10, Price BETWEEN ? AND ?;',data, //pID = *, data, pName,pBrand,Description,Condition,pType,Price,ProductAdded FROM Product
        (err, results, fields) => {
